        ...
        switch($fieldtype) {
            ...
            case 'title':
                ...
                if(!$this->_iset_field($tablename,'thumb')){
                    if($thumb==1) {
                        $sql[] = "ALTER TABLE `$tablename` ADD `thumb` VARCHAR( 100 ) NOT NULL DEFAULT '' COMMENT '缩略图'";
                    }
                }else{
                    if($thumb==0) {
                ...
                if(!$this->_iset_field($tablename,'title_style')){
                    if($style==1) {
                        $sql[] = "ALTER TABLE `$tablename` ADD `title_style` VARCHAR( 100 ) NOT NULL DEFAULT '' COMMENT '标题样式'";
                    }
                }else{
                    if($style==0) {
            ...
            case 'posid':
                $sql = "ALTER TABLE `$tablename` $do `$field` TINYINT(2) UNSIGNED NOT NULL DEFAULT '0' COMMENT '$comment'";
                break;
