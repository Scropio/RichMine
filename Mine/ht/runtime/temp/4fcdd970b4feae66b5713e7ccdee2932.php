<?php /*a:1:{s:66:"/www/wwwroot/ht.zzhr168.cn/application/admin/view/login/index.html";i:1564941676;}*/ ?>
<!DOCTYPE html>
<html lang="zh_cn">
<head>
    <meta charset="utf-8">
                    ...
                    <div class="beg-login-main">
                        <form class="layui-form layui-form-pane" method="post">
                            ...
                            <div class="layui-form-item">
                                ...
                                <input type="password" name="password1" lay-verify="required" placeholder="这里输入二级密码" value="" class="layui-input">
                            </div>                          
