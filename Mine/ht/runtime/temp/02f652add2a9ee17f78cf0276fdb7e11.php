<?php /*a:3:{s:65:"/www/wwwroot/ht.zzhr168.cn/application/admin/view/news/index.html";i:1564236896;s:66:"/www/wwwroot/ht.zzhr168.cn/application/admin/view/common/head.html";i:1564236899;s:66:"/www/wwwroot/ht.zzhr168.cn/application/admin/view/common/foot.html";i:1564236899;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="admin-main layui-anim layui-anim-upbit">
    <fieldset class="layui-elem-field layui-field-title">
        <legend><?php echo lang('article'); ?>管理</legend>
    </fieldset>
    <div class="demoTable">
        ...
        <a href="<?php echo url('add'); ?>" class="layui-btn" style="float:right;"><i class="fa fa-plus" aria-hidden="true"></i><?php echo lang('add'); ?><?php echo lang('article'); ?></a>
    ...
    layui.use(['table','form'], function() {
        ...
        var tableIn = table.render({
            ...
            cols: [[
                ...
                {field: 'title', title: '新闻标题', width: 400,templet: '#title'},
                {field: 'catname', title: '新闻类型', width: 160},
                {field: 'createtime', title: '<?php echo lang("add"); ?><?php echo lang("time"); ?>',width: 150},
