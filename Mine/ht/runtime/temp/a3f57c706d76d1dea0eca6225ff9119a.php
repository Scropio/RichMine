<?php /*a:3:{s:70:"/www/wwwroot/ht.zzhr168.cn/application/admin/view/users/groupForm.html";i:1564236895;s:66:"/www/wwwroot/ht.zzhr168.cn/application/admin/view/common/head.html";i:1564236899;s:66:"/www/wwwroot/ht.zzhr168.cn/application/admin/view/common/foot.html";i:1564236899;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form class="layui-form layui-form-pane">
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                ...
                <a href="<?php echo url('userGroup'); ?>" class="layui-btn layui-btn-primary"><?php echo lang('back'); ?></a>
            </div>
        </div>
    </form>
</div>
...
<script>
    ...
    m.controller('ctrl',['$scope',function($scope) {
        $scope.field = '<?php echo $info; ?>'!='null'?<?php echo $info; ?>:{level_id:'',level_name:'',bomlimit:'',toplimit:'',sort:50};
