    ...
    $sk.fn = $sk.prototype = {}, $sk.fn.extend = $.extend, $sk.fn.extend({
        ...
        setup: function () {
            ...
            var addImageLink = function (link, src, animation_type, label, target) {
                if (self.settings.images_links.push([src, link, animation_type, label, target]), self.settings.thumbs) {
                    var dimension_thumb = "";
                    dimension_thumb = self.settings.width_skitter > self.settings.height_skitter ? 'height="100"' : 'width="100"', self.skitter_box.find(".info_slide").append('<span class="image_number' + initial_select_class + '" rel="' + (u - 1) + '" id="image_n_' + u + "_" + self.number_skitter + '" style="background-image: url(' + src + ');"></span> ')
            ...
            if (this.settings.xml ? $.ajax({
                ...
                self.skitter_box.find(".info_slide_thumb").width(width_info_slide), self.skitter_box.css({height: self.skitter_box.height() + self.skitter_box.find(".info_slide").height()}), self.skitter_box.append('<div class="container_thumbs"></div>');
                ...
                if (info_slide_thumb.find(".image_number").each(function () {
                    ...
                    self.skitter_box.find(".info_slide").width("auto"), self.skitter_box.find(".box_scroll_thumbs").hide();
            ...
            if (this.skitter_box.find("ul").hide(), this.settings.show_randomly && this.settings.images_links.sort(function (a, b) {
                ...
                return 0 == self.settings.is_animating && (self.settings.image_i -= 2, self.settings.image_i == -2 ? self.settings.image_i = self.settings.images_links.length - 2 : self.settings.image_i == -1 && (self.settings.image_i = self.settings.images_links.length - 1), self.jumpToImage(self.settings.image_i)), !1
        ...
        loadImages: function () {
            ...
            for (var i in this.settings.images_links) {
                ...
                $(img).load(function () {
                    ++u, u == total && (self.skitter_box.find(".skitter-spinner").remove(), self.start())
                }).error(function () {
        ...
        animationBlock: function (options) {
            ...
            for (i = 0; i < total; i++) {
                var _bleft = width_box * i, _btop = 0, box_clone = this.getBoxClone();
                box_clone.css({
        ...
        animationHorizontal: function (options) {
            ...
            for (i = 0; i < total; i++) {
                var _bleft = (i % 2 == 0, "" + width_box), _btop = i * height_box, box_clone = this.getBoxClone();
                box_clone.css({
                    left: _bleft + "px",
                    top: _btop + "px",
                    width: width_box,
        ...
        animationTube: function (options) {
            ...
            var max_w = self.getMaxW(10),
                ...
                width_box = Math.ceil(this.settings.width_skitter / total), height_box = this.settings.height_skitter;
            for (i = 0; i < total; i++) {
                var _btop = 0, _vtop = height_box, vleft = width_box * i, box_clone = this.getBoxClone();
                box_clone.css({
                    left: vleft,
                    top: _vtop,
                    height: height_box,
        ...
        animationFade: function (options) {
            ...
            this.setActualLevel();
            var width_box = this.settings.width_skitter, height_box = this.settings.height_skitter, total = 2;
            for (i = 0; i < total; i++) {
                var _vtop = 0, _vleft = 0, box_clone = this.getBoxClone();
                box_clone.css({
                    left: _vleft,
                    top: _vtop,
                    width: width_box,
        ...
        animationFadeFour: function (options) {
            ...
            var easing = "" == this.settings.easing_default ? "easeOutQuad" : this.settings.easing_default,
                time_animate = 500 / this.settings.velocity;
            this.setActualLevel();
            var width_box = this.settings.width_skitter, height_box = this.settings.height_skitter, total = 4;
            for (i = 0; i < total; i++) {
        ...
        animationParalell: function (options) {
            ...
            var easing = "" == this.settings.easing_default ? "easeOutQuad" : this.settings.easing_default,
                time_animate = 400 / this.settings.velocity;
            this.setActualLevel();
            var max_w = 16, total = Math.ceil(this.settings.width_skitter / (this.settings.width_skitter / max_w)),
                width_box = Math.ceil(this.settings.width_skitter / total), height_box = this.settings.height_skitter;
            for (i = 0; i < total; i++) {
                var _bleft = width_box * i, _btop = 0, box_clone = this.getBoxClone();
                box_clone.css({
        ...
        animationCubeSpread: function (options) {
            ...
            for (i = 0; i < total; i++) {
                init_top = i % 2 == 0 ? init_top : -init_top, init_left = i % 2 == 0 ? init_left : -init_left;
                var _vtop = init_top + height_box * col_t, _vleft = init_left + width_box * col,
                    _vtop_image = -(height_box * col_t), _vleft_image = -(width_box * col), _btop = _vtop,
                    _bleft = _vleft;
        ...
        animationGlassBlock: function (options) {
            ...
            var max_w = self.getMaxW(10),
                ...
                width_box = Math.ceil(this.settings.width_skitter / total), height_box = this.settings.height_skitter;
            for (i = 0; i < total; i++) {
                var _ileft = width_box * i, _itop = 0, _fleft = width_box * i, _ftop = 0, _bleft = -(width_box * i),
                    _btop = 0, delay_time = 100 * i, box_clone = this.getBoxClone();
                box_clone.css({
                    left: _ileft,
                    top: _itop,
                    width: width_box,
        ...
        animationCubeShow: function (options) {
            ...
            var easing = "" == this.settings.easing_default ? "easeOutQuad" : this.settings.easing_default,
                time_animate = 400 / this.settings.velocity;
            this.setActualLevel();
            var max_w = self.getMaxW(8), max_h = 4,
                division_w = Math.ceil(this.settings.width_skitter / (this.settings.width_skitter / max_w)),
        ...
        animationDirectionBars: function (options) {
            ...
            for (i = 0; i < total; i++) {
                var _vtop = 0, _vleft = width_box * i, _vtop_image = 0, _vleft_image = -(width_box * i),
                    box_clone = this.getBoxCloneImgOld(image_old);
                box_clone.css({
                    left: _vleft + "px",
                    top: _vtop + "px",
        ...
        animationHideBars: function (options) {
            ...
            for (i = 0; i < total; i++) {
                var _vtop = 0, _vleft = width_box * i, _vtop_image = 0, _vleft_image = -(width_box * i),
                    _fleft = "+=" + width_box, box_clone = this.getBoxCloneImgOld(image_old);
                box_clone.css({
                    left: 0,
                    top: 0,
                    width: width_box,
        ...
        animationSwapBlocks: function (options) {
            ...
            this.setActualLevel(), this.setLinkAtual(), this.skitter_box.find(".image_main").attr({src: this.getCurrentImage()}), this.skitter_box.find(".image_main").hide();
            var total = 2, width_box = this.settings.width_skitter,
        ...
        increasingImage: function () {
            this.settings.image_i++, this.settings.image_i == this.settings.images_links.length && (this.settings.image_i = 0)
        },
        ...
        focusSkitter: function () {
            ...
            var _top = $(".skitter_box").offset().top, _left = $(".skitter_box").offset().left;
            self.skitter_box.find(".focus_button").click(function () {
                ...
                return self.skitter_box.before('<div id="mark_position"></div>'), $("body").prepend(div), $("body").prepend(self.skitter_box), self.skitter_box.css({
                    ...
                    top: _topFinal,
                    left: _leftFinal
                }, 2e3, "easeOutExpo"), $("#mark_position").width($(".skitter_box").width()).height($(".skitter_box").height()).css({background: "none"}).fadeTo(300, .3), !1
        ...
        startProgressBar: function () {
            var self = this;
            return !(self.settings.is_hover_skitter_box || self.settings.is_paused || self.settings.is_blur || !self.settings.progressbar) && void self.skitter_box.find(".progressbar").hide().dequeue().width(self.settings.progressbar_css.width).animate({width: "show"}, self.settings.interval, "linear")
        },
        ...
        resumeProgressBar: function () {
            var self = this;
            return !(self.settings.is_hover_skitter_box || self.settings.is_paused || !self.settings.progressbar) && void self.skitter_box.find(".progressbar").dequeue().animate({width: self.settings.progressbar_css.width}, self.settings.interval - self.settings.elapsedTime, "linear")
        },
        hideProgressBar: function () {
            var self = this;
            return !!self.settings.progressbar && void self.skitter_box.find(".progressbar").stop().fadeOut(300, function () {
        ...
        randomUnique: function (valorIni, valorFim) {
            var numRandom;
            do numRandom = Math.random(); while (1 == numRandom);
        ...
        setTouchSupport: function () {
            ...
            isTouch && (this.skitter_box.on("touchstart", function (e) {
