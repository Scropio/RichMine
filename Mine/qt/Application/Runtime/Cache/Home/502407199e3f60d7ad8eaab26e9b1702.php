...
<head>
    ...
    <style>
        ...
        .pwd-btn{background-color: #FF7F00;}
...
<div class="aui-content-padded" style="width: 100%; background-color: rgba(115,115,100,0.5)!important; margin:0 !important; padding: 4% 8%!important;position: absolute; overflow: scroll;height: 90%;"  >

    <p style="color: #fff; font-size: 0.8rem; text-align: center;" >实名认证正在审核</p>
