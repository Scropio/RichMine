...
<div class="aui-content-padded" style="overflow: scroll;height: 90%;" >
    ...
    <form action="/index.php/home/index/douptwopwd" method="post">
            ...
            <div class="aui-list-item-inner">
                <div class="aui-list-item-input" style="color: #f00">
                    <input type="text" name="sendCode"  id="sendCode" placeholder="验证码" style="width: 50%;float: left;">
                        <button type="button" onclick="senduptwoCode(this)"
		                       id="send-code" style="    height: 40px;" >发送验证码
		                </button>
                </div>
            </div>
        </li>
        <p><button type="submit" class="aui-btn aui-btn-success aui-btn-block pwd-btn">修改二级密码</button></p>
    </ul>
...
<script type="text/javascript">
    ...
    function senduptwoCode(target) {
        var url ='/index.php/home/user/getuptwoCode';// $(target).attr('data-url');
        var mobile = '';       
